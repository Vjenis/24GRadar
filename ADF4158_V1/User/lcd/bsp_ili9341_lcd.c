 ...
 * @retval 无
 */
void ILI9341_Display_Num ( uint16_t usX, uint16_t usY, uint8_t num, uint16_t usColor_Background, uint16_t usColor_Foreground )
{
    if ( ( usX - macILI9341_DispWindow_X_Star + macWIDTH_EN_CHAR ) > macILI9341_DispWindow_COLUMN )
		{
			usX = macILI9341_DispWindow_X_Star;
		...
		ILI9341_DispChar_EN ( usX, usY, num, usColor_Background, usColor_Foreground );
